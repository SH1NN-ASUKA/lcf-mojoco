...
extern uint8_t img_temp[60][80];
extern int img3[60][80];//图像二值化之后的数组
extern int img1[60][80];//图像二值化之后的数组
extern int imgdisplay[60][80];//打印的图像数组
extern uint8 Garage_Location_Flag;//斑马线累积初始次数


extern int image_temp_flag;
extern int image_temp_flag1[2];
extern int image_temp_flag_r;
extern int image_temp_flag1_r[2];
extern float pppwwpw;
